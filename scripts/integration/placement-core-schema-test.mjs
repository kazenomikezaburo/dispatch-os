...
const sql = `begin;
insert into public.projects (id, branch_id, name, start_date, end_date, status) values
  ('98000000-0000-0000-0000-000000000101', 'b0000000-0000-0000-0000-000000000001', 'Placement schema test Nagoya', '2099-01-01', '2099-12-31', 'draft'),
  ('98000000-0000-0000-0000-000000000102', 'b0000000-0000-0000-0000-000000000002', 'Placement schema test Tokyo', '2099-01-01', '2099-12-31', 'draft');
insert into public.jobs (id, project_id, workplace_id, name, status) values
  ('98000000-0000-0000-0000-000000000201', '98000000-0000-0000-0000-000000000101', (select id from public.workplaces where branch_id='b0000000-0000-0000-0000-000000000001' order by id limit 1), 'Placement schema test Job', 'draft'),
  ('98000000-0000-0000-0000-000000000202', '98000000-0000-0000-0000-000000000102', (select id from public.workplaces where branch_id='b0000000-0000-0000-0000-000000000002' order by id limit 1), 'Placement schema test Foreign Job', 'draft');
insert into public.shift_slots (id, job_id, starts_at, ends_at, required_workers, status) values
  ('98000000-0000-0000-0000-000000000301', '98000000-0000-0000-0000-000000000201', '2099-01-15T00:00:00Z', '2099-01-15T09:00:00Z', 2, 'draft'),
  ('98000000-0000-0000-0000-000000000302', '98000000-0000-0000-0000-000000000201', '2099-02-01T22:00:00Z', '2099-02-02T06:00:00Z', 1, 'draft'),
  ('98000000-0000-0000-0000-000000000303', '98000000-0000-0000-0000-000000000202', '2099-03-15T00:00:00Z', '2099-03-15T09:00:00Z', 1, 'draft');
insert into public.assignments (id, shift_slot_id, worker_id, source, status) values
  ('98000000-0000-0000-0000-000000000401', '98000000-0000-0000-0000-000000000301', 'c0000000-0000-0000-0000-000000000002', 'manager', 'assigned'),
  ('98000000-0000-0000-0000-000000000402', '98000000-0000-0000-0000-000000000302', 'c0000000-0000-0000-0000-000000000001', 'manager', 'assigned');

select 'existing Assignment without plan remains valid', (not exists (select 1 from public.shift_placement_plans where shift_slot_id = '98000000-0000-0000-0000-000000000302'::uuid))::text;
select 'existing Shift without plan remains valid', (not exists (select 1 from public.shift_placement_plans where shift_slot_id = '98000000-0000-0000-0000-000000000302'::uuid))::text;

insert into public.shift_placement_plans (id, shift_slot_id) values
  ('90000000-0000-0000-0000-000000000001', '98000000-0000-0000-0000-000000000301'),
  ('90000000-0000-0000-0000-000000000002', '98000000-0000-0000-0000-000000000303'),
  ('90000000-0000-0000-0000-000000000003', '98000000-0000-0000-0000-000000000302');

do $$ begin
  insert into public.shift_placement_plans (id, shift_slot_id) values
    ('90000000-0000-0000-0000-000000000004', '98000000-0000-0000-0000-000000000301');
...
insert into public.assignment_placement_segments (id, plan_id, shift_slot_id, assignment_id, position_id, start_at, end_at) values
  ('92000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000001', '98000000-0000-0000-0000-000000000301', '98000000-0000-0000-0000-000000000401', '91000000-0000-0000-0000-000000000001', '2099-01-15T00:00:00Z', '2099-01-15T03:00:00Z'),
  ('92000000-0000-0000-0000-000000000002', '90000000-0000-0000-0000-000000000001', '98000000-0000-0000-0000-000000000301', '98000000-0000-0000-0000-000000000401', '91000000-0000-0000-0000-000000000002', '2099-01-15T03:00:00Z', '2099-01-15T09:00:00Z'),
  ('92000000-0000-0000-0000-000000000003', '90000000-0000-0000-0000-000000000003', '98000000-0000-0000-0000-000000000302', '98000000-0000-0000-0000-000000000402', '91000000-0000-0000-0000-000000000004', '2099-02-01T22:00:00Z', '2099-02-02T02:00:00Z'),
  ('92000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000003', '98000000-0000-0000-0000-000000000302', '98000000-0000-0000-0000-000000000402', '91000000-0000-0000-0000-000000000004', '2099-02-02T02:00:00Z', '2099-02-02T06:00:00Z');
...
do $$ begin
  insert into public.assignment_placement_segments (plan_id, shift_slot_id, assignment_id, position_id, start_at, end_at) values
    ('90000000-0000-0000-0000-000000000001', '98000000-0000-0000-0000-000000000301', '98000000-0000-0000-0000-000000000401', '91000000-0000-0000-0000-000000000001', '2099-01-15T02:59:00Z', '2099-01-15T04:00:00Z');
...
do $$ begin
  insert into public.assignment_placement_segments (plan_id, shift_slot_id, assignment_id, position_id, start_at, end_at) values
    ('90000000-0000-0000-0000-000000000001', '98000000-0000-0000-0000-000000000301', '98000000-0000-0000-0000-000000000401', '91000000-0000-0000-0000-000000000001', '2099-01-15T09:00:00Z', '2099-01-15T09:00:00Z');
  raise exception 'expected check violation';
exception when check_violation then null;
end $$;
...
do $$ begin
  insert into public.assignment_placement_segments (plan_id, shift_slot_id, assignment_id, position_id, start_at, end_at) values
    ('90000000-0000-0000-0000-000000000001', '98000000-0000-0000-0000-000000000301', '98000000-0000-0000-0000-000000000401', '91000000-0000-0000-0000-000000000003', '2099-01-15T09:00:00Z', '2099-01-15T10:00:00Z');
...
do $$ begin
  insert into public.assignment_placement_segments (plan_id, shift_slot_id, assignment_id, position_id, start_at, end_at) values
    ('90000000-0000-0000-0000-000000000002', '98000000-0000-0000-0000-000000000303', '98000000-0000-0000-0000-000000000401', '91000000-0000-0000-0000-000000000003', '2099-03-15T00:00:00Z', '2099-03-15T01:00:00Z');
  raise exception 'expected foreign key violation';
exception when foreign_key_violation then null;
end $$;
