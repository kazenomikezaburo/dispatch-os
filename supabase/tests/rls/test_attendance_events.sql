...
select test_rls.assert_denied('RLS-AE-006', 'Attendance Integrity', $$insert into public.attendance_events (id, assignment_id, event_type, source, idempotency_key) values ('60000000-0000-0000-0000-000000000094','40000000-0000-0000-0000-000000000002','depart','manager','61000000-0000-0000-0000-000000000094')$$, 'INSERT', 'Nagoya manager event; RPC required');
...
select test_rls.assert_denied('RLS-AE-009', 'Attendance Integrity', $$insert into public.attendance_events (id, assignment_id, event_type, source, idempotency_key) values ('60000000-0000-0000-0000-000000000097','40000000-0000-0000-0000-000000000003','depart','manager','61000000-0000-0000-0000-000000000097')$$, 'INSERT', 'system admin manager event; RPC required');
