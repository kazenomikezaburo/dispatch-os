...
select test_rls.assert_denied('RLS-PSC-004', 'Critical', $$update public.pre_shift_confirmations set comment = 'TEST denied' where id = '50000000-0000-0000-0000-000000000003'$$, 'UPDATE', 'immutable future confirmation');
...
select test_rls.assert_denied('RLS-PSC-006B', 'Critical', $$update public.pre_shift_confirmations set comment = 'TEST manager denied' where id = '50000000-0000-0000-0000-000000000001'$$, 'UPDATE', 'immutable Nagoya confirmation');
